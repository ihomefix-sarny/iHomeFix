...
const DEFAULT_PRICES = {
  x:R(2200,4200,900,1400,1100,700), xr:R(2100,2200,1100,1000,1700,1000), xs:R(2400,4200,900,1400,1100,700),
  xsm:R(2600,4500,1200,1200,2400,1000), "11":R(2400,2400,1200,1500,1600,1900), "11p":R(2700,3900,1400,1600,2500,2000),
  "11pm":R(2900,4200,1500,1700,2800,2000), "12":R(2900,5200,1600,2100,2800,1900), "12m":R(2700,4900,1150,1600,1500,850),
  "12p":R(3300,5200,1600,2100,2800,1900), "12pm":R(3500,7300,1900,2300,3700,2200), "13":R(3500,5500,2000,2400,3100,2400),
  "13m":R(3300,6200,1350,1800,1700,950), "13p":R(4000,8600,2100,2600,3800,2500), "13pm":R(4300,9400,2200,2700,3600,2500),
...
async function loadCloud(){
  try{
    ...
    // відвідувачі — з GitHub. адмін — свої локальні правки не затираємо
    if(!admin){
